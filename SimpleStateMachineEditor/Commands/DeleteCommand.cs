...
namespace SimpleStateMachineEditor.Commands
{
    ...
    internal sealed class DeleteCommand
    {
        ...
        private DeleteCommand(SimpleStateMachineEditorPackage package, OleMenuCommandService commandService)
        {
            this.Package = package ?? throw new ArgumentNullException(nameof(package));
            commandService = commandService ?? throw new ArgumentNullException(nameof(commandService));

            var menuCommandID = new CommandID(PackageGuids.guidSimpleStateMachineEditorPackageCmdSet, PackageIds.DeleteCommandId);
        ...
        private void Execute(object sender, EventArgs e)
        {
            ...
            Package.ActiveDesignerControl?.DeleteSelectedIcons();
        }
    }
}
