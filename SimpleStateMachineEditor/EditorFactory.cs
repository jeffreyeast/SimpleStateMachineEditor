...
namespace SimpleStateMachineEditor
{
    ...
    /// </summary>
    [Guid(GuidList.guidDesignerEditorFactoryString)]
    public sealed class EditorFactory : IVsEditorFactory, IDisposable
    {
        public const string Extension = ".sfsa";

        private SimpleStateMachineEditorPackage editorPackage;
        private ServiceProvider vsServiceProvider;


        public EditorFactory(SimpleStateMachineEditorPackage package)
        {
                        ...
                        out int pgrfCDW)
        {
            ...
            pguidCmdUI = GuidList.guidDesignerEditorFactory;
            pgrfCDW = 0;
