...
namespace SfsaItemTemplate
{
    using System;
    using System.Collections.Generic;
    using SimpleStateMachine;

    public abstract class StateMachine : StateMachineWithoutReturnValueBase
    {
        ...
        public StateMachine() : base (StateClassifications, EventTypeNames, StateNames)
        {
