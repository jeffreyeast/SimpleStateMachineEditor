...
namespace RuntimeTestsCore
{
    ...
    public abstract class StateMachineWithoutValue : StateMachineWithoutReturnValueBase
    {
        ...
        protected abstract void RaiseException();


        protected override Transition<Action>[,] Transitions => _transitions;
        Transition<Action>[,] _transitions;

        public StateMachineWithoutValue() : base (StateClassifications, EventTypeNames, StateNames)
        {
            _transitions = new Transition<Action>[,]
            {
                ...
                { // S1(1)
                    ...
                    new Transition<Action>(0, new Action[] { }),  // Finish(4)
                },
                { // S2(2)
                    new Transition<Action>(0, new Action[] { base.InvalidTransition, }),  // Advance(0)
                    new Transition<Action>(0, new Action[] { base.InvalidTransition, }),  // BeginTest(1)
